   ...
   */
    ...
    class Architecture {
      ...
      protected:
        ...
        std::shared_ptr<triton::arch::CpuInterface> cpu;
      ...
      public:
        ...
        //! Restore the instance of an old CPU state.
        TRITON_EXPORT void restoreInstance(triton::arch::architecture_e arch, std::shared_ptr<triton::arch::CpuInterface> cpu);
    };
