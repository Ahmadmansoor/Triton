 ...
 */
   ...
   */
     ...
     */
      ...
      //! Creates the ContextSnapshot python class.
      ...
      //! pyContextSnapshot object.
      typedef struct {
        PyObject_HEAD
        triton::engines::snapshot::SnapshotEngine* snapshot; //! Pointer to the cpp snapshot engine
      } ContextSnapshot_Object;

      extern PyTypeObject ContextSnapshot_Type;
...
/*! Checks if the pyObject is a triton::engines::snapshot::SnapshotEngine. */
#define PyContextSnapshot_Check(v) ((v)->ob_type == &triton::bindings::python::ContextSnapshot_Type)

/*! Returns the triton::engines::snapshot::SnapshotEngine. */
#define PyContextSnapshot_AsSnapshotEngine(v) (((triton::bindings::python::ContextSnapshot_Object*)(v))->snapshot)
